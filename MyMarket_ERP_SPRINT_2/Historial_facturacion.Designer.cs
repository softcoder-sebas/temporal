...
namespace MyMarket_ERP
{
    partial class Historial_facturacion
    {
        ...
        private void BuildInvoiceInfo()
        {
            ...
            var invoiceHeader = new TableLayoutPanel
            {
                Dock = DockStyle.Top,
                ColumnCount = 2,
                RowCount = 1,
            ...
            invoiceHeader.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100F)); // título ocupa todo el espacio disponible
            invoiceHeader.ColumnStyles.Add(new ColumnStyle(SizeType.AutoSize));    // botón tamaño automático
            ...
            btnDescargar = new Button
            {
                ...
                AutoSize = false,
                Size = new Size(160, 36), // ancho moderado
            ...
            invoiceHeader.Controls.Add(lblDetalleTitulo, 0, 0);
            invoiceHeader.Controls.Add(btnDescargar, 1, 0);
            ...
            // Agregar en orden: header (titulo + boton) y luego info secundaria
            invoiceInfoPanel.Controls.Add(invoiceHeader);
