...
namespace MyMarket_ERP
{
    partial class Inventario
    {
        ...
        private void BuildTabOrdenes()
        {
            ...
            // place right after btnToggleDetalle (272 + 150 + 8 = 430)
            btnEvaluarProveedor.Width = 160;
            btnEvaluarProveedor.Location = new Point(430, 8);
            btnEvaluarProveedor.Anchor = AnchorStyles.Top | AnchorStyles.Left;

            // Move the search/filter controls closer to the Registrar proveedor button.
            txtBuscar = new TextBox
            {
                PlaceholderText = "Buscar por número o proveedor…",
                Width = 260,
                Location = new Point(352, 10) // moved left to sit next to Registrar proveedor
            };
            ...
            cmbEstado = new ComboBox
            {
                ...
                Width = 180,
                Location = new Point(624, 10) // shifted left accordingly
            };

            chkFecha = new CheckBox
            {
                Text = "Filtrar por fecha",
                Location = new Point(816, 12),
                AutoSize = true
            };
            ...
            pagerPanel.Controls.AddRange(new Control[] { btnAnterior, btnSiguiente, btnToggleDetalle, btnEvaluarProveedor });
