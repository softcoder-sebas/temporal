...
namespace MyMarket_ERP
{
    partial class Empleados
    {
        ...
        private Label lblDTipoContrato;
        private Label lblDCompensacion;
        private Label lblDDuracionContrato;
        ...
        private void BuildContent()
        {
            ...
            lblDTipoContrato = CreateDetailLabel();
            lblDCompensacion = CreateDetailLabel();
            lblDDuracionContrato = CreateDetailLabel();
            ...
            AddDetail(detailList, "Tipo de contrato", lblDTipoContrato);
            AddDetail(detailList, "Caja de compensación", lblDCompensacion);
            AddDetail(detailList, "Duración contrato", lblDDuracionContrato);
